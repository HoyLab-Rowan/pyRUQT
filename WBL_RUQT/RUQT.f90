      ...
      real(8), allocatable, dimension(:),INTENT(IN) :: fock_matrix, overlap_matrix
      ...
      real(8), allocatable, dimension(:,:), INTENT(OUT) :: trans_results,current_results
