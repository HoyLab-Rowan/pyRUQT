...
***This version of RUQT serves as the NEGF libraries for the pip distribution of pyRUQT. It is no longer a standalone code, is maintained seperately from the original code, and likely will not work with old RUQT inputs or outside of pyRUQT without modificaiton.
