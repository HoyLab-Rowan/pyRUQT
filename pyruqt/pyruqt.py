...
class sie_negf:
 ...
 def transmission(self):
  ...
  plt.clf()
  np.savetxt(inp['output']+".trans",np.c_[energies,T],fmt="%s")
...
class wbl_negf:
 ...
 def current(self):
  ...
  if inp['fort_trans']==False:
   T,I=ruqt.call_wbl_ruqt("current",outputfile,h,s,norb,numelec,elec_orb,inp,energies,bias)
