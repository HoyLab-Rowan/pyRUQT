...
#This is a storage file for older subroutines (or pieces of them) that were used in previous versions of pyRUQT.
...
def old_ruqt_inputs(Calc_Type, Electrode_Type, FermiE, Fermi_Den, norb, numocc, numvirt, size_ex, size_elec, min_trans_energy, max_trans_energy, delta_energy, min_bias, max_bias, delta_bias, KT, rdm_doubles, use_b0, b0_type, state_num):
#This part writes the options to the input file for the RUQT Fortran code
 with open("fort_ruqt",'w') as negf_inp:
